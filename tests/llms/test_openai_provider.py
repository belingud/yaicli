...
class TestOpenAIProvider:
    ...
    def test_init(self, mock_config, mock_openai_client):
        ...
        OpenAI.assert_called_once_with(**provider.client_params)
    ...
    def test_convert_messages(self, mock_config, mock_openai_client):
    ...
    def test_detect_tool_role(self, mock_config, mock_openai_client):
